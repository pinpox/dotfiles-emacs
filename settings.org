...
** [[https://github.com/abo-abo/swiper][ivy/swiper/counsel]]
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (setq ivy-re-builders-alist
           '((t   . ivy--regex-fuzzy)))    ;; configure regexp engine to use fuzzy finding, together with flx
   #+END_SRC

   Ivy-rich displays additional information for the items in ivy. I use mostly
   the default config for it for now, but there is more room for customization
   and improvemend here.
