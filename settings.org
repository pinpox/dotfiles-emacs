...
** Indentation and whitespace
   ...
   style for a buffer or a language. I set tabs as defualt and then revert the
   setting for those languages on which I want spaces.

   The size of tabs is extracted into a variable, so I set it once and use it as
   needed.
